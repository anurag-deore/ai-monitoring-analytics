...
from .controllers import chat_controller, transaction_controller, dashboard_controller
...
# Include routers
app.include_router(chat_controller.router, tags=["Chat & Queries"])
app.include_router(transaction_controller.router, prefix="/transactions", tags=["Transactions"])
app.include_router(dashboard_controller.router, prefix="/dashboards", tags=["Dashboards"])
